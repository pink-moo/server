...
module.exports.fetchVariant = function (player, index = player.weaponIndex) {
	var tmpXP = player.weaponXP[index] || 0
...
// VOLCANO:
module.exports.volcanoEnabled = false
module.exports.volcanoPos = 13960
module.exports.volcanoScale = 320
module.exports.volcanoDamageRange = 1400
module.exports.volcanoMobsRange = 1530

// OTHERS:
module.exports.maxSameIpConnections = 25
module.exports.allowSimultStoreActions = false
module.exports.enhancedSandbox = true

// ZOMBIE MODE:
module.exports.campStoneWidth = 20
module.exports.campStoneHeight = 15
